...
void printUsages(const string prog) {
    ...
    cout << "OPTIONS" << endl;
    cout <<
    "   -a               run with files in sizes of tinyEWG, mediumEWG,";
    cout << endl;
    cout << "                    largeEWG, 1000EWG, 10000EWG." << endl;
    cout << "   -f <filePath>    run with the specified data file,";
    cout << endl;
    cout << "                    overrides -a." << endl;
    cout << "   -h               print out this usage, overrides all others.";
    cout << endl;
    cout << "   -l <debug level> set the message output level which can one of";
    cout << endl;
    cout << "                    the following: error, warning, info, debug.";
    cout << endl;
}
