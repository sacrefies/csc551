...
static VectorBucketSort * random_buckets(const int list_size, const int max_buckets) {
    VectorBucketSort * bs = new VectorBucketSort(list_size);
...
int main(int argc, char * argv[]) {
    ...
    cout << endl;
    VectorBucketSort * bs = random_buckets(bucket_size, max_buckets);
    cout << *bs << endl;
